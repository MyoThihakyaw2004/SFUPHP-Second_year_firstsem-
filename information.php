          ...
          <div class="card-body">
            <h5 class="card-title">Educate teenagers</h5>
            <p class="card-text">The primary aim is to educate teenagers about the various aspects of online safety and the responsible use of technology. This involves raising awareness about the risks and opportunities that come with digital platforms.</p>
          </div>
          ...
          <div class="card-body">
            <h5 class="card-title">Mental health aspects of social media use</h5>
            <p class="card-text">Address the mental health aspects of social media use, such as managing screen time, understanding the impact of social comparison, and knowing when to disconnect.</p>
          </div>
          <div class="card-footer">
            <small class="text-body-secondary">Last updated 3 mins ago</small>
          </div>
          ...
          <div class="card-body">
            <h5 class="card-title">Feel safe to express themselves</h5>
            <p class="card-text">  Create an environment where teenagers feel safe to express themselves, seek help, and report inappropriate or harmful content.</p>
          </div>
          <div class="card-footer">
            <small class="text-body-secondary">Last updated 3 mins ago</small>
          </div>
          ...
          <div class="card animated-card">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Teenagers with the skills needed</h5>
                        <p class="card-text"> Equip teenagers with the skills needed to critically evaluate online content. This includes understanding how to identify misinformation, manage digital footprints, and utilize privacy settings effectively.</p>
                      </div>
                      <div class="card-footer">
                        <small class="text-body-secondary">Last updated 3 mins ago</small>
                      </div>
          ...
          <div class="col-md-4">
          <div class="card animated-card">
                      <img src="./image/p7.png" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Natural lead-in</h5>
          ...
          <div class="card animated-card">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">The benefits and dangers of the social media </h5>
                        <p class="card-text">Envision a world where teenagers are well-informed about the benefits and dangers of the internet, and are empowered to make smart, safe choices online.</p>
                      </div>
                      <div class="card-footer">
                        <small class="text-body-secondary">Last updated 3 mins ago</small>
                      </div>
