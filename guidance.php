    ...
    <head>
        ...
        <title>Legislation and Guidance on Social Media Use</title>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Legislation and Guidance on Social Media Use</h1>

        <section id="legislation">
            <h2>Legislation</h2>
            <p>Here you can find information about various laws and regulations that govern the use of social media. This includes data protection laws, cyberbullying laws, copyright laws, etc.</p>
    
            <ul>
                <li><strong>Data Protection Act 2018</strong> - Governs the processing of personal data.</li>
                <li><strong>Computer Misuse Act 1990</strong> - Covers cybercrimes including hacking and unauthorized access to computer systems.</li>
        ...
        <section id="guidance">
            ...
            <p>This section provides best practices for individuals and organizations to safely and responsibly use social media platforms.</p>
            <ul>
                <li><strong>Privacy Settings:</strong> Regularly review and adjust your privacy settings on social media platforms.</li>
                <li><strong>Content Sharing:</strong> Be mindful of the content you share and its potential impact.</li>
            </ul>
        </section>
